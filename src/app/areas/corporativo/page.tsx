...
export const metadata: Metadata = {
  title: "Derecho Corporativo | Medina Almonte Firma Legal",
  description:
      ...
      <section className="section-navy-gradient min-h-screen py-24 px-4">
        <div className="max-w-4xl mx-auto text-center glass-card gold-border-gradient rounded-2xl p-6 sm:p-8">
          ...
          <ScrollReveal delay={0.3}>
            <a
              href="https://api.whatsapp.com/send?phone=51943366950&text=Hola%2C%20necesito%20una%20consulta%20legal%20en%20Derecho%20Corporativo%20-%20Medina%20Almonte%20Firma%20Legal."
              target="_blank"
