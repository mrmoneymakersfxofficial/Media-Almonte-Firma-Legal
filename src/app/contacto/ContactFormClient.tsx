...
const contactInfo = [
  {
    icon: Phone,
    label: "WhatsApp",
    value: "+51 943 366 950",
    href: "https://api.whatsapp.com/send?phone=51943366950",
    color: "#25D366",
  },
  {
    icon: Mail,
    label: "Correo Electrónico",
    value: "contacto@medinaalmonte.com",
...
export default function ContactFormClient() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    toast({
      ...
      description: "Se abrirá WhatsApp con tu consulta. Nuestro equipo te responderá pronto.",
    });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Cuéntanos tu situación legal. Completa el formulario y te
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-[#0A0A0A] border-white/10 text-white placeholder:text-gray-600 h-12 rounded-lg focus-visible:border-[#D4AF37]/60 focus-visible:ring-[#D4AF37]/20"
                />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      pattern="[0-9]{9}"
                      placeholder="943 366 950"
                      value={formData.telefono}
                      onChange={handleChange}
                      className="bg-[#0A0A0A] border-white/10 text-white placeholder:text-gray-600 h-12 rounded-lg pl-12 focus-visible:border-[#D4AF37]/60 focus-visible:ring-[#D4AF37]/20"
                    />
                  </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-[#0A0A0A] border border-white/10 text-white h-12 rounded-lg px-3 text-sm focus:outline-none focus:border-[#D4AF37]/60 focus:ring-2 focus:ring-[#D4AF37]/20 appearance-none cursor-pointer"
                  style={{
                ...
                >
                  ...
                  {CASE_TYPES.map((tipo) => (
                    <option key={tipo} value={tipo} className="bg-[#111111]">
                      {tipo}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                <Textarea
                  ...
                  minLength={10}
                  rows={5}
                  placeholder="Describe brevemente tu situación legal o consulta..."
                  value={formData.mensaje}
                  onChange={handleChange}
                  className="bg-[#0A0A0A] border-white/10 text-white placeholder:text-gray-600 rounded-lg resize-none focus-visible:border-[#D4AF37]/60 focus-visible:ring-[#D4AF37]/20 min-h-[120px]"
                />
              ...
              <p className="text-gray-600 text-xs text-center pt-1">
                Al enviar, se abrirá WhatsApp con tu consulta prellenada. Tu
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="bg-gradient-to-br from-[#0B1A2E] to-[#0A0A0A] border border-[#D4AF37]/20 rounded-xl p-6 mt-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                Escribe directamente por WhatsApp y recibe una respuesta
                inmediata de nuestro equipo legal.
              </p>
              <a
