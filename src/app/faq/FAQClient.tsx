...
const faqs = [
  ...
  { question: "¿Qué áreas del derecho abarcan?", answer: "Contamos con especialistas en Derecho Civil, Penal, Laboral, Corporativo y de Familia. Nuestro equipo multidisciplinario permite abordar casos complejos que involucren múltiples ramas del derecho, garantizando una defensa integral y coordinada." },
  ...
  { question: "¿Cuánto tiempo dura un proceso legal?", answer: "La duración varía según el tipo de caso y la jurisdicción. Un proceso laboral conciliatorio puede resolverse en 2-3 meses, mientras que un litigio civil complejo puede extenderse por más de un año. Desde la primera consulta te proporcionamos una estimación realista de los plazos involucrados." },
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <ScrollReveal delay={0.4}>
          <div className="mt-16 text-center">
            ...
            <a href="https://api.whatsapp.com/send?phone=51943366950&text=Hola%2C%20tengo%20una%20consulta%20sobre%20sus%20servicios%20legales." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 btn-gold-primary gpu-accelerated text-[#0F0F0F] font-bold text-sm px-7 py-3 rounded-xl">
